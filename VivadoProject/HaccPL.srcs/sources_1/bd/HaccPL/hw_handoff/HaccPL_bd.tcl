...
################################################################
# This is a generated script based on design: HaccPL
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: RadiationReceiver_0, and set properties
  set block_name RadiationReceiver
  set block_cell_name RadiationReceiver_0
  if { [catch {set RadiationReceiver_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $RadiationReceiver_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins RadiationReceiver_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net RadiationReceiver_0_leds [get_bd_ports leds] [get_bd_pins RadiationReceiver_0/leds]
  connect_bd_net -net RadiationReceiver_0_requestEthernetValues [get_bd_pins RadiationReceiver_0/requestEthernetValues] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net RadiationReceiver_0_valueReady [get_bd_pins RadiationReceiver_0/valueReady] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins RadiationReceiver_0/S_AXI_ACLK] [get_bd_pins RadiationReceiver_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins RadiationReceiver_0/S_AXI_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs RadiationReceiver_0/S_AXI/reg0] -force
